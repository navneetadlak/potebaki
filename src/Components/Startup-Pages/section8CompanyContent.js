import React from 'react'
  ...
  export const section8CompanyContent = {
      PricingSection: {
            ...
            description: "Easily register a Section 8 company through IndiaFilings along with current account opening.",
            ...
            products: [
              {
                title: "Incorporation",
                price: "INR 2899",
                offers: ["MCA Name Approval", "Incorporation Fee", "Company Incorporation", "Hyper Token", "DSC Support & Shipping", "1 Year LEDGERS License", "Bank Account Assistance"],
                allInclusive: true,
              },
            //   {
          ...
          "sidebar": {
            ...
            "guides": [
              {
                "title": "Section 8 Company Registration: A Comprehensive Guide to Incorporate NGO",
                "link": "#"
              },
              {
                "title": "What is difference between NGO and Section 8 company?",
                "link": "#"
              },
              {
              ...
              {
                "title": "Can Section 8 company make profit?",
                "link": "#"
              },
              {
                "title": "Section 8 Company",
        ...
        //         },
            ...
            //     {
            //       heading: "Key Points about Section 8 Company Act", 
            ...
            //   ],
              requiredDocumentsec: [
                {
                  heading: "Key Points about Section 8 Company Act", 
                //   subheading: "Incorporating a Section 8 company in India offers numerous advantages, some highlighted below.",
                },
                {
                  title: "In India, Non-Governmental Organizations (NGOs) can be registered under the Registrar of Societies or as a non-profit entity under Section 8 Company of the Companies Act, 2013.",
                //   description: 
                ...
                {
                  title: "Profit generated by Section 8 Companies cannot be used for purposes other than charitable objectives and cannot be distributed among shareholders.",
                //   description: 
                ...
                {
                  title: "Section 8 Companies are similar to the erstwhile Section 25 Company under the Company Act 1956. As per the prevailing Company Act, these are now recognized as Section 8 Companies.",
                //   description: 
                ...
                {
                  title: "Section 8 Companies are required to comply with the provisions of the Companies Act 2013. They are mandated to maintain books of accounts, file returns with the Registrar of Companies (ROCs), and comply with GST and IT Act.",
                //   description: 
                ...
                {
                  title: "Any changes to the charter documents like the Articles of Association (AoA) and Memorandum of Association (MoA) require the government's consent.",
                //   description: 
            ...
            //   ],
                ...
                //   },
                 ...
                 privateRegistration : {
                  heading: "Section 8 Company Incorporation Process",
                  intro: "The process of incorporating Section 8 companies in India involves the following steps:",
                    sections: [
                    {
                    //   title: "Step 1: Obtain Digital Signature Certificate (DSC)",
                      steps: [
                        { stepTitle: "Step 1: Obtain Digital Signature Certificate (DSC)", stepDescription: "The first step is to obtain a Digital Signature Certificate (DSC) for the proposed directors of the Section 8 Company. This certificate is required for the online filing of documents with the Ministry of Corporate Affairs (MCA). Form DIR-3 is used for obtaining the DIN and should be filed along with the DSC of the proposed directors.\n\n Forms to be used: DIR-3, DSC" },
                        { stepTitle: "Step 2: Obtain Director Identification Number (DIN)", stepDescription: "After obtaining the DSC, the next step is to apply for a Director Identification Number (DIN) for the proposed directors. The DIN number is a unique identification number issued by the MCA to individuals who wish to be directors of a company in India. \n\n Forms to be used: DIR-3" },
                        { stepTitle: "Step 3: Reserve the Company Name", stepDescription: "The next step is to reserve the name of the proposed Company with the MCA. The Section 8 company name should be unique and not be similar to any existing company name. Form INC-1 is used for reserving the company name.\n\n Forms to be used: INC-1" },
                        { stepTitle: "Step 4: File the Application for Incorporation", stepDescription: "After the company name is approved, the next step is to apply for Section 8 Company incorporation. The application for incorporation is filed in Form INC-32 along with the Company's Memorandum of Association (MOA) and Articles of Association (AOA).\n\n Forms to be used: INC-32, MOA, and AOA" },
                        { stepTitle: "Step 5: Obtain a License for Section 8 Company", stepDescription: "Once the application for incorporation is approved, the next step is to obtain a license for the Section 8 Company. Form INC-12 is used for obtaining the license. It should be filed along with the necessary documents.\n\n Forms to be used: INC-12" },
                        { stepTitle: "Step 6: Obtain a Certificate of Incorporation", stepDescription: "After obtaining the license, the MCA issues a Certificate of Incorporation in Form INC-16. This certificate confirms the incorporation of the Section 8 Company.\n\n Forms to be used: INC-16 \n\n In summary, the forms used for Section 8 Company registration are DIR-3, DSC, INC-1, INC-32, MOA, AOA, INC-12, and INC-16." },
