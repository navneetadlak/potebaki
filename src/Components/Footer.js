      ...
      <footer className="bg-[#101010] py-12">
        <div className="container mx-auto px-4 flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <p className="text-[#F8F8F8] mb-4">
              Unleash your business potential with Lemonix the invigorating SaaS
              platform. Elevate productivity and growth. Try it now!
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/potebakiaccounts/photos"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/potebaki.in/?hl=en"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/company/potebaki/"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <div className="w-full md:w-1/4">
            ...
            <form className="flex flex-col space-y-4">
              ...
              />
              <button className="px-4 py-2 bg-[#488FCD] text-white rounded hover:bg-indigo-500 transition">
                Subscribe
              </button>
            </form>
          </div>
