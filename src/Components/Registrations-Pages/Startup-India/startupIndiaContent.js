import React from 'react'
  ...
  export const startupIndiaContent = {
    PricingSection: {
      title: "Startup India",
      customerRating: {
        rating: 4.4,
      ...
      description: "Easily get Startup India registration through DPIIT.",
      ...
      products: [
        {
          ...
          price: "INR 2899",
          offers: ["Business Consultation", "Pitch Deck", "Application Filing", "DPIIT Recognition", "Startup India Certificate"],
          allInclusive: true,
        },
        {
          title: "Startup India + DSC",
          price: "INR 6988",
          offers: ["Business Consultation","Pitch Deck", "Application Filing", "DPIIT Recognition", "Startup India Certificate", "Class 3 DSC - Company"],
          allInclusive: true,
        }
      ]
    },
    ...
    "sidebar": {
      ...
      "guides": [
        {
          "title": "A Comprehensive Guide to Startup India Registration: Eligibility, Benefits, and Procedure",
          "link": "#"
        },
        {
          "title": "Is Startup India a scheme?",
          "link": "#"
        },
        {
          "title": "Who is eligible for Startup India?",
          "link": "#"
        },
        {
    ...
    // partnership: [
        ...
        partnerinindia: [
            {
                heading: "Eligibility Criteria for Start-up India Registration",
                subheading:
              ...
              },
              {
                ...
                description:
                  "The startup must be incorporated as a private limited company, a limited liability partnership (LLP), or a partnership firm.",
              },
              {
                title: "Age of the Startup",
                description:
                  "The startup should be at most ten years from its incorporation. However, startups in the biotechnology sector are allowed up to 15 years.",
              },
              {
                title: "Annual Revenue",
                description:
                  "The startup's yearly turnover must not exceed INR 100 crores in any fiscal year since its inception.",
              },
              {
                title: "Innovative Approach",
                description:
                  "The startup must aim to innovate, develop, deploy, or commercialise new products, processes, or services driven by technology or intellectual property.",
              },
              {
                title: "DPIIT Recognition",
                description:
                  "The startup must acquire a startup India certificate from the Department for Promotion of Industry and Internal Trade (DPIIT).",
              },
              {
                title: "Legal Compliance",
                description:
                  "The startup must comply with all relevant legal requirements, such as the Companies Act, Income Tax Act, and Goods and Services Tax Act. Additionally, it must maintain a bank account in the business's name and provide these details during DPIIT registration.",
              },
              {
                title: "Job Creation",
                description:
                  "The startup should either contribute to job creation or have the potential to do so in the future, aligning with the Startup India scheme’s objective to stimulate employment within the country.",
              },
            ],
    ...
    //   },
      ...
      requiredDocumentsec: {
          heading: "Documents Required for Start India Registration",
          subheading: "To complete the registration of startup in India and obtain DPIIT recognition for your startup, you will need the following documents:",
          titles: [
        ...
        advantages: [
            {
              ...
              {
                title: "Self-certification under Employment and Labour Laws",
                description:
              ...
              {
                title: "Environment-Related Acts Exemption",
                description:
              ...
              {
                title: "Relaxed Public Procurement Norms",
                description:
    ...
    //     ],
        ...
        //     ],
          ...
          privateRegistration: {
            heading: "Startup India Registration Process",
            intro:
            ...
            sections: [
              {
                steps: [
                  ...
                  {
                    stepTitle: "Obtain DPIIT Registration",
                    stepDescription:
